...
namespace AjaxPractice.Controllers
{
    public class AjaxSampleController : Controller
    {
        ...
        // GET: AjaxSample/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AjaxSample/Create
